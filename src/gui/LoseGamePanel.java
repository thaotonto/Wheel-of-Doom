...
public class LoseGamePanel extends JPanel {
    ...
    private JLabel correctAnwerLabel;
    private String correctAnswer;

    public LoseGamePanel() {
        correctAnswer = "The correct answer is:<br>" + GameController.specialRound.getPhrase();
        correctAnwerLabel = new JLabel("<html>" + correctAnswer + "</html>");
        correctAnwerLabel.setFont(new Font(null, Font.BOLD, 20));
        correctAnwerLabel.setForeground(Color.YELLOW);
        add(correctAnwerLabel);
        correctAnwerLabel.setBounds(90, 350, 600, 100);
        setLayout(null);
